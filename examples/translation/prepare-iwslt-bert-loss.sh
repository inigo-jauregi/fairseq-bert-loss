...
BPE_TOKENS=32000
BERT_MODEL=pretrained-LMs/bert-base-chinese
...
src=en
tgt=zh
dataset=datasets/zh-en_TEDtalks
dataset_out=datasets/en-zh_TEDtalks
train=train
dev=dev2010
test=test
...
for l in $tgt; do
    ...
    #cp $dataset_out/test/$f $dataset_out/test/$tok.$l
